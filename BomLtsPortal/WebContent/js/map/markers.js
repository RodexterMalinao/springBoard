...
var initLat = 22.316567;
var initLng = 114.119341;
...
//	alert("disp_now = "+disp_now+", disp_nowB = "+disp_nowB+", disp_net = "+disp_net+", disp_netB = "+disp_netB);
	...
	if (disp_net){
		...
		contentString.push('&nbsp;<img src="./images/regi_icon.gif" onclick="showForm(\'net\',\''+ encodeURIComponent(mymarker.getMarker_idx())+ '\',this);" title="'+bubble_icon_regi_net+'"/>');	
		contentString.push('</div>');
	...
	contentString.push('&nbsp;<img src="./images/regi_icon.gif" onclick="showForm(\'now\',\''+ encodeURIComponent(mymarker.getMarker_idx())+ '\',this);" title="'+bubble_icon_regi_now+'"/>');
	contentString.push('</div>');
	contentString.push('<div style="clear:both;"></div>');
	contentString.push('</div>');	
	}
