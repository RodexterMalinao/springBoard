function myMarker(opt_options) {
	...
	if (options["res_eye"])
		this.RES_EYE = options["res_eye"];
	if (options["res_eye_pe"])
		this.RES_EYE_PE = options["res_eye_pe"];
	if (options["res_tel"])
		this.RES_TEL = options["res_tel"];
	if (options["IS_CLEANED_VILLAGE"])
		this.IS_CLEANED_VILLAGE = options["IS_CLEANED_VILLAGE"];
	...
	if (this.RES_EYE == "Y" || this.RES_EYE_PE == "Y") {
		this._isEye = true;
	}
...
myMarker.prototype.getRes_eye = function(){
	return this.RES_EYE;
};
myMarker.prototype.setRes_eye = function(res_eye) {
this.RES_EYE = res_eye;
};
myMarker.prototype['setRes_eye'] = myMarker.prototype.setRes_eye;

myMarker.prototype.getRes_eye_pe = function(){
	return this.RES_EYE_PE;
};
myMarker.prototype.setRes_eye_pe = function(res_eye_pe) {
this.RES_EYE_PE = res_eye_pe;
};
myMarker.prototype['setRes_eye_pe'] = myMarker.prototype.setRes_eye_pe;

myMarker.prototype.getRes_tel = function(){
	return this.RES_TEL;
};
myMarker.prototype.setRes_tel = function(res_tel) {
this.RES_TEL = res_tel;
};
myMarker.prototype['setRes_tel'] = myMarker.prototype.setRes_tel;


myMarker.prototype.isEye = function(){
	return this._isEye;
};
myMarker.prototype.setEye = function(isEye) {
this._isEye = isEye;
};
myMarker.prototype['setEye'] = myMarker.prototype.setEye;

myMarker.prototype.isTel = function(){
	return this._isTel;
};
myMarker.prototype.setTel = function(isTel) {
this._isTel = isTel;
};
myMarker.prototype['setTel'] = myMarker.prototype.setTel;
...
myMarker.prototype.setPremier = function(IS_PREMIER) {
this.IS_PREMIER = IS_PREMIER;
};
myMarker.prototype['setPremier'] = myMarker.prototype.setPremier;

myMarker.prototype.isCleanedVillage = function(){
	return this.IS_CLEANED_VILLAGE;
};
myMarker.prototype.setCleanedVillage = function(IS_CLEANED_VILLAGE) {
this.IS_CLEANED_VILLAGE = IS_CLEANED_VILLAGE;
};
myMarker.prototype['setCleanedVillage'] = myMarker.prototype.setCleanedVillage;
