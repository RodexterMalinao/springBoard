...
<form:form method="POST" action="approvallogin.html" name="loginForm" commandName="approvalLoginForm">
<div class="supportDocForm">
	...
	<div class="buttonmenubox_R" id="buttonArea">
		...
		<input type="hidden" name="currentView" value="approvallogin.html">
		<input type="hidden" id="approvalInd" value="${approvalLoginForm.approvalInd }"/>
