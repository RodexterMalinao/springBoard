...
// 			$('#dateDatepickerEnd').datepicker( "option", "maxDate", new Date (2999,1,1));
		...
		function isInputOkayBeforeSubmit(){
			if(((document.getElementById('dateDatepickerStart')==null ||document.getElementById('dateDatepickerStart').value=='')||
					...
					(document.getElementById('orderType')==null ||document.getElementById('orderType').value=='')){
									...
									<tr>
										...
										<td style="width:300px">
											<form:select id="orderType" path="orderType">
												...
												<form:option value="P_R_T" label="Pcd Ret Add on Tv" />
												<form:option value="PCD_V" label="Pcd Ret Only Vas" />
												...
												<form:option value="NTVRE" label="NTV-Retention" />
											</form:select>
										</td>
										<!-- martin 20140905 end -->
									</tr>	
