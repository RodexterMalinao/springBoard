...
.previewForm h3 { margin: 0; font-size: medium; color: white; background-color: #6CA9F5; padding: 5px 10px; position: relative }
...
<%--			</table>--%>
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<c:if test="${bomsalesuser.mobPilotStatus == 'A'}">
			<td align="center" style="padding: 10px 0">
				<div>
					<a href="#" onclick="createMobOrder()" class="nextbutton">
						Mobile Acquisition
					</a>
				</div>
			</td>
			...
			<c:if test="${bomsalesuser.ltsPilotStatus == 'A'}">			
				<c:choose>			
					<c:when test="${bomsalesuser.channelId == 10 or bomsalesuser.channelId == 11 or bomsalesuser.channelId == 12 or bomsalesuser.channelId == 13}">
						<td align="center" style="padding: 10px 0">
							<div>
								<a id="ltsAcqOrderBtn" href="#" class="nextbutton">
									LTS Acquisition
								</a>
							</div>
