<%
	...
	String moblieNum = (String)request.getSession().getAttribute("directSalesMobileNumber");
	String username = "";
		...
		<div id="head">
			...
			<div id="wrapper">
				...
				<div class="supportDocForm">
					<h3>IMS Error</h3>
					<p>Operation Fail. Staff Num <%= username %> cannot access SB with this mobile number.</p>
