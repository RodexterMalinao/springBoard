...
<form:form method="POST" action="imslogin.html" name="loginForm" commandName="bomsalesuser">
<div class="supportDocForm"> 
	<h3 class="table_title">Please quit if you are not IT of PCCW BOM Springboard IMS Support</h3>
	...
	<div class="row">
		<span class="label contenttext">Password(no need enter)<span class="contenttext_red">*</span></span>
