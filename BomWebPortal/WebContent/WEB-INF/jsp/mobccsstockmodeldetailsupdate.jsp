...
<script type="text/javascript">
	function formSubmit(actType) {
		if (confirm("Apply Insert / Update Action?")) {
			document.stockModelDetailsUpdateForm.actionType.value = "UPDATE";
			document.stockModelDetailsUpdateForm.submit();
		}
	}
...
<form:form name="stockModelDetailsUpdateForm" method="POST" commandName="stockModelDetailsUpdate">
	...
	<table width="100%" class="tablegrey">
		<tr>
			...
			<table width="100%" border="0" cellspacing="1" rules="none">
				<tr>
					<td class="table_title">Stock Inventory Maintenance (Model Details Update)</td>
				</tr>
			</table>
			...
			<tr>
				<td>Item Code:</td>
				<td><form:input path="itemCode" disabled="${true}"/></td>
			</tr>
			<tr>
				<td>Model:</td>
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			...
			<div><a href="#" class="nextbutton" onClick="javascript:formSubmit('UPDATE')">Save</a></div>
			</td>
