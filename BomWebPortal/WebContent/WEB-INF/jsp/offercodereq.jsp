...
<body>
<div class="container">
  <form:form method="POST" commandName="form" id="signup">
    ...
    <div class="header">
      <h3>
        <spring:message code="label.offercodereq.please_enter_mobile_number" />
      </h3>
    </div>
    <div class="inputs">
      <input id="mobileNum" name="mobileNum" placeholder="<spring:message code="label.offercodereq.mobile_number" />" type="tel" value="${form.mobileNum }" maxlength="8"/>
      <p class="error"><form:errors path="mobileNum" cssClass="error" /></p>
      <button id="submit" ><spring:message code="label.offercodereq.submit" /></button>
