...
<body>
	...
	<br />
	<br />
	<div style="float: left; font-size: 10pt;">Thank you for choosing ${brandString} as your mobile service provider. Please complete the address validation process by emailing this letter to TelesalesSupportCUST@hkcsl.com or faxing it to 2164 3998 within 14 days of ${srdDate}.</div>
	<div class="clearboth"></div>
	<br />
	...
	<div class="clearboth"></div>
	<br />
	<div style="float: left; font-size: 10pt;">If you have any queries, feel free to contact one of our sales executives.</div>
	<div class="clearboth"></div>
	<br />
