...
<body>
	...
	<br />
	<br />
	<div style="float: left; font-size: 10pt;">Thank you for choosing ${brandString} as your mobile service provider. Please complete the address validation process by emailing this letter to MobileSupport@hkcsl.com or faxing it to 3748 9628 within 14 days of ${srdDate}.</div>
	<div class="clearboth"></div>
	<br />
