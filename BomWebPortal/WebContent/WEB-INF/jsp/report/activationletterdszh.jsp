...
<body>
	...
	<br />
	<div style="float: left; font-size: 10pt;">多謝閣下選用${brandString}，為讓閣下可繼續使用我們的優質服務，敬請於服務啟用日期由${srdDate}起計 14 天內, 電郵此確認信至電郵地址 MobileSupport@hkcsl.com 或傳真至傳真號碼 3748 9628 為地址確認。</div>
	<div class="clearboth"></div>
	<br />
