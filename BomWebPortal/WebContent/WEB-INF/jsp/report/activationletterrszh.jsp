...
<body>
	...
	<br />
	<div style="float: left; font-size: 10pt;">多謝閣下選用${brandString}，為讓閣下可繼續使用我們的優質服務，敬請於服務啟用日期由${srdDate}起計 14 天內, 攜同此確認信到申請服務之${shopString}
	(${shopInfo.chiDesc}, 地址: ${shopInfo.chiAddr1}${shopInfo.chiAddr2}${shopInfo.chiAddr3}${shopInfo.chiAddr4}) 辦理地址確認手續。</div>
	<div class="clearboth"></div>
	<br />
	...
	<div class="clearboth"></div>
	<br/>
	<div style="float: left; font-size: 10pt;"><img src="images/tickbox.jpg" height="30" /> 申請CSL Mobile Limited 流動通訊服務</div>
	<div class="clearboth"></div>
	<br/>
	<div style="float: left; font-size: 10pt;"><img src="images/tickbox_empty.jpg" height="30" /> 申請HKT Payment Limited Tap &amp; Go Card</div>
	<div class="clearboth"></div>
	<br/>
