...
$(function() {
	...
	$('#deliveryDate').datepicker().css('z-index', 1); 
			...
			<table width="100%" border="0" cellspacing="0" class="contenttext">
				...
				<table width="100%" border="0" cellspacing="1">
					...
					<tr class="contenttext">
						...
						<td>
							<form:input id="lastName" path="contactInfo.lastName" maxlength="40"/>
							<div><form:errors path="contactInfo.lastName" cssClass="error" /></div>
						</td>
						
						<td><b>Given Name</b></td>
						<td>
							<form:input id="firstName" path="contactInfo.firstName" maxlength="40"/>
					...
					<tr class="contenttext">
						...
						<td>
							<form:input path="contactInfo.contactPhone" maxlength="8" />
							<div><form:errors path="contactInfo.contactPhone" cssClass="error" /></div>
							
						</td>
						<td><b>Email</b></td>
						<td>
							<form:input path="contactInfo.emailAddr" maxlength="64" />
			...
			<table width="100%" border="0" cellspacing="0" class="contenttext">
				...
				<table width="100%" border="0" cellspacing="1">
					...
					<tr class="contenttext">
						...
						<td><b>Flat</b></td>
						<td>
							<form:input id="unitNo" path="deliveryInfo.unitNo" maxlength="5" />
							<div><form:errors path="deliveryInfo.unitNo" cssClass="error" /></div>
						</td>
						<td><b>Floor</b></td>
						<td><form:input id="floorNo" path="deliveryInfo.floorNo" maxlength="3" /></td>
					</tr>
					<tr class="contenttext">
						<td width="6%">&nbsp;</td>
					...
					<tr class="contenttext">
						...
						<td>
							<form:input id="strNo" path="deliveryInfo.strNo" maxlength="11"/>
							<div><form:errors path="deliveryInfo.strNo" cssClass="error" /></div>
						</td>
						<td><b>Street Name</b></td>
						<td><form:input id="strName" path="deliveryInfo.strName" maxlength="23" /></td>						
					</tr>
					<tr class="contenttext">
						<td width="6%">&nbsp;</td>
