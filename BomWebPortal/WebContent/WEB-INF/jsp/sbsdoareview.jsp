...
$(document).ready(function() {
	$("#cancelBtn").click(function(event) {
		...
		//document.location="sbsdoa.html?orderId=${order.orderId}";
		document.getElementById('backlink').click();
	});
	$("#confirmBtn").click(function(event) {
		event.preventDefault();
		if (confirm('Contact and delivery information will be updated. Order status will be changed to "DOA Delivery arranged". Are you sure to proceed ?')) {
...
<base target="_self"/>
<body >
<a id="backlink" href="sbsdoa.html?orderId=${order.orderId}" style="display:none"></a>
<div id="container">
<div id="head">
<div id="header">
