    ...
    */
    function AutoComplete_ShowDropdown(id)
    {
        ...
        if(value.charAt(value.length-1)==" "){        	
        	...
        	__AutoComplete[id]['data'] = iaData;  
        	
        	//alert("The length is " + __AutoComplete[id]['data'].length);
        	var toDisplayIndex = 0;
        	toDisplay = new Array();
	        for (i = 0; value.length > 0 && i < __AutoComplete[id]['data'].length; ++i) {
	//            if (__AutoComplete[id]['data'][i].substr(0, value.length) == value) {	
	        	//alert(__AutoComplete[id]['data'][i]);
	            // ******* if (__AutoComplete[id]['data'][i].toUpperCase().indexOf(value.toUpperCase()) != -1) {
	            	//alert(__AutoComplete[id]['data'][i]);
	                //toDisplay[toDisplay.length] = __AutoComplete[id]['data'][i];
	                toDisplay[toDisplayIndex] = __AutoComplete[id]['data'][i];
	                toDisplayIndex++;
	            // ******* }
    ...
    */
    function AutoComplete_HideAll()
    {
        ...
        if (document.getElementById('divSelectAddress') != undefined) {
            document.getElementById('divSelectAddress').style.visibility = 'hidden';
        }
    }
    ...
    */
    ...
    {
    	var highlightValue = __AutoComplete[id]['dropdown'].childNodes[__AutoComplete[id]['highlighted']].innerHTML;
        ...
        for (i=0;i<iaData.length;i++){
        	if(highlightValue==iaData[i]){
        		selectedIndex = i;
        		break;
        	}
        }
        /*alert("selectedIndex: " + selectedIndex);
       alert("areaDesc: " + areaDesc[selectedIndex]);
        alert("iaData: " + iaData[selectedIndex]);
        alert("areaDesc: " + areaDesc.length);
        alert("iaData: " + iaData.length);*/
        //alert("areaDesc: " + areaDesc[selectedIndex]);
        ...
        if (document.getElementById('houseLotNum') != undefined) {
            document.getElementById('houseLotNum').value = houseLotNum[selectedIndex];
        }
