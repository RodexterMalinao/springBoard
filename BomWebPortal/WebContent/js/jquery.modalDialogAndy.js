...
var modalWindow = {
		...
		open : function() {
			...
			div += "<div id=\"" + this.windowId
	 			+ "\" title=\"" + this.title + "\" style=\"overflow: hidden; margin: 0; padding: 0;\" >";
			...
			var divDialog = $(div).dialog({
											...
											close: function(event, ui) {
												...
												$("[name='qcItem']").each(function(i,e){
													if($(e).attr("checked")) $(e).attr("disabled",true);
