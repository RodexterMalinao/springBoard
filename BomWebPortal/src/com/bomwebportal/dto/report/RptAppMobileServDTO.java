...
public class RptAppMobileServDTO extends ReportDTO {
	...
	public static final String JASPER_TEMPLATE_CY = "M2AppMobileServCY";	
	public static final String JASPER_TEMPLATE_UNI = "M2AppMobileServUni";	
	public static final String JASPER_TEMPLATE_RET = "M2AppMobileServRet";	
	...
	private boolean mobCustNotice = false;
	
	private String billDateEng;
	...
	public boolean isMobCustNotice() {
		return mobCustNotice;
	}

	public void setMobCustNotice(boolean mobCustNotice) {
		this.mobCustNotice = mobCustNotice;
	}
	...
	public String getBillDateEng() {
		if("1".equals(this.billPeriod)) {
		return "st";
		}
		else if("11".equals(this.billPeriod)) {
			return "st";
			}
		else if("21".equals(this.billPeriod)) {
			return "st";
			}
		else if("31".equals(this.billPeriod)) {
			return "st";
			}
		else if("2".equals(this.billPeriod)) {
			return "nd";
			}
		else if("22".equals(this.billPeriod)) {
			return "nd";
			}
	...
	public void setBillDateEng(String billDateEng) {
		this.billDateEng = billDateEng;
	}
	...
	public void setAppendTcStartDate(Date appendTcStartDate) {
		AppendTcStartDate = appendTcStartDate;
	}
