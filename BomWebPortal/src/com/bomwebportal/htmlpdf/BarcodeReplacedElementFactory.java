...
// https://github.com/andyHa/scireumOpen/blob/master/src/com/scireum/open/fs/BarcodeReplacedElementFactory.java
// http://www.javacodegeeks.com/2012/12/generating-barcodes-in-pdfs-with-flying-saucer.html
public class BarcodeReplacedElementFactory extends ITextReplacedElementFactory {
	...
	public ReplacedElement createReplacedElement(LayoutContext c, BlockBox box,
		...
		if (nodeName.equals("img")) {
			if ("code128".equals(e.getAttribute("type"))) {
				...
				if (fsImage != null) {
					if (cssWidth != -1 || cssHeight != -1) {
						Dimension newSize = computeResizeBox(
								cssWidth, cssHeight, fsImage);
						if (newSize != null) {
							fsImage.scale((int)newSize.getWidth(),
	...
	private Dimension computeResizeBox(int cssWidth,
