...
public class LtsAcqDnPoolDAO extends BaseDAO {
	...
	public List<String> getLockedDnList(String sessionId) throws DAOException {
		...
		try {
			paramSource.addValue("status", LtsConstant.DN_POOL_STATUS_LOCKED);
	...
	public List<String> getReservedDnList(String sessionId) throws DAOException {
		...
		try {
			paramSource.addValue("status", LtsConstant.DN_POOL_STATUS_RESERVED);
			paramSource.addValue("sessionId", sessionId);
			return (List<String>) simpleJdbcTemplate.getNamedParameterJdbcOperations().queryForList(
					sql.toString(), paramSource, String.class);
    ...
    public void updDnStatusToReserve(List<String> dnList, String oStatus, String sessionId) throws DAOException {
    ...
    public void updDnStatusToConfirm(String srvNum, String sessionId) throws DAOException {
		...
		try {
			paramSource.addValue("status", LtsConstant.DN_POOL_STATUS_CONFIRMED);
	...
	public void updDnStatusToNormal(String oStatus, String sessionId) throws DAOException {
		MapSqlParameterSource paramSource = new MapSqlParameterSource();
		...
		try {
			paramSource.addValue("nStatus", LtsConstant.DN_POOL_STATUS_NORMAL);
			paramSource.addValue("oStatus", oStatus);
			paramSource.addValue("sessionId", sessionId);
			simpleJdbcTemplate.getNamedParameterJdbcOperations().update(sql.toString(), paramSource);
		} catch (Exception e) {
	...
	public void updDnStatusToNormalBySrvNum(List<String> dnList, String oStatus, String sessionId) throws DAOException {
		MapSqlParameterSource paramSource = new MapSqlParameterSource();
	...
	public void releaseDnStatusToLockedByReservedDn(List<String> dnList, String sessionId) throws DAOException {
		MapSqlParameterSource paramSource = new MapSqlParameterSource();
		...
		try {
			paramSource.addValue("nStatus", LtsConstant.DN_POOL_STATUS_LOCKED);
			paramSource.addValue("sessionId", sessionId);
			paramSource.addValue("oStatus", LtsConstant.DN_POOL_STATUS_RESERVED);
			paramSource.addValue("dnList", dnList);
			simpleJdbcTemplate.getNamedParameterJdbcOperations().update(sql.toString(), paramSource);
		} catch (Exception e) {
	...
	public void releaseDnStatusToNormalByConfirmedDn(String srvNum) throws DAOException {
		...
		try {
			paramSource.addValue("nStatus", LtsConstant.DN_POOL_STATUS_NORMAL);
			paramSource.addValue("oStatus", LtsConstant.DN_POOL_STATUS_CONFIRMED);
			paramSource.addValue("srvNum", srvNum);
			simpleJdbcTemplate.getNamedParameterJdbcOperations().update(sql.toString(), paramSource);
		} catch (Exception e) {
    ...
    public void assignDn(String dn) throws DAOException {
		...
		try {
			paramSource.addValue("status", LtsConstant.DN_POOL_STATUS_ASSIGNED);
