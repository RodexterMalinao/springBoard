...
public class ServiceSummaryDTO implements Serializable {
	...
	public static final String STATUS_STATE_BACKDATE_OVER_120 = "BACKDATE_OVER_120";
	public static final String STATUS_STATE_DISC_5NA = "DISC_5NA";
	public static final String STATUS_STATE_PROFILE_OUTDATED = "PROFILE_OUTDATED";
	public static final String STATUS_STATE_DISABLED_SELF_PICKUP = "DISABLED_SELF_PICKUP";
	...
	private String billAddrChangeInd = null;
	private String billingAddress = null;
	private String billingAddrInstantUpdateInd = null;
	...
	private String newDuplexNum = null;
	...
	private String ltsEmailBillAddr = null;
	...
	private boolean fieldVisitRequired = false;
	...
	private String allowSelfPickup = null;
	...
	private String transfereeCompanyName = null;
	...
	// Re-contract deceased case
	private String deceasedType= null;
	private String transferorNewBillingName;
	private String transferorNewBillingAddr;
	
	// PDPO
	private String custOptOutInd;
	private String updBomStatus;
	...
	private List<ItemDetailSummaryDTO> dnchangeChargeList = null;
	private List<ItemDetailSummaryDTO> dnYchangeChargeList = null;
	...
	private String redemptionSms;
	private String redemptionEmail;
	
	//BOM2018061
	private ItemDetailSummaryDTO epdItem = null;
	...
	public List<ItemDetailSummaryDTO> getDnchangeChargeList() {
		return dnchangeChargeList;
	}

	public void setDnchangeChargeList(List<ItemDetailSummaryDTO> dnchangeChargeList) {
		this.dnchangeChargeList = dnchangeChargeList;
	}
	...
	public void addDnChangeItem(ItemDetailSummaryDTO pItem){
		if(this.dnchangeChargeList == null){
			this.dnchangeChargeList = new ArrayList<ItemDetailSummaryDTO>();
		}
		this.dnchangeChargeList.add(pItem);
	}
	
	public void addDnyChangeItem(ItemDetailSummaryDTO pItem){
		if(this.dnYchangeChargeList == null){
			this.dnYchangeChargeList = new ArrayList<ItemDetailSummaryDTO>();
		}
		this.dnYchangeChargeList.add(pItem);
	}
	...
	public String getBillAddrChangeInd() {
		return this.billAddrChangeInd;
	}

	public void setBillAddrChangeInd(String pBillAddrChangeInd) {
		this.billAddrChangeInd = pBillAddrChangeInd;
	}
	...
	public List<ItemDetailSummaryDTO> getDnYchangeChargeList() {
		return dnYchangeChargeList;
	}

	public void setDnYchangeChargeList(
			List<ItemDetailSummaryDTO> dnYchangeChargeList) {
		this.dnYchangeChargeList = dnYchangeChargeList;
	}
	...
	public String getTransfereeCompanyName() {
		return transfereeCompanyName;
	}

	public void setTransfereeCompanyName(String transfereeCompanyName) {
		this.transfereeCompanyName = transfereeCompanyName;
	}
	...
	public String getTransferorNewBillingName() {
		return transferorNewBillingName;
	}

	public void setTransferorNewBillingName(String transferorNewBillingName) {
		this.transferorNewBillingName = transferorNewBillingName;
	}

	public String getTransferorNewBillingAddr() {
		return transferorNewBillingAddr;
	}

	public void setTransferorNewBillingAddr(String transferorNewBillingAddr) {
		this.transferorNewBillingAddr = transferorNewBillingAddr;
	}

	public String getCustOptOutInd() {
		return custOptOutInd;
	}

	public void setCustOptOutInd(String custOptOutInd) {
		this.custOptOutInd = custOptOutInd;
	}
	...
	public ItemDetailSummaryDTO getEpdItem() {
		return epdItem;
	}

	public void setEpdItem(ItemDetailSummaryDTO epdItem) {
		this.epdItem = epdItem;
	}

	public String getAllowSelfPickup() {
		return allowSelfPickup;
	}

	public void setAllowSelfPickup(String allowSelfPickup) {
