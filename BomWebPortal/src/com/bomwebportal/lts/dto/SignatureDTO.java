...
public class SignatureDTO implements Serializable{
	...
	public enum SignatureType {
		EYEX_CUST_SIGN,
		EYEX_THIRD_PARTY_SIGN,
		BANK_SIGN, CCARD_SIGN,
		REL_DEL_CUST_SIGN,
		REL_DEL_THIRD_PARTY_SIGN,
		SEC_DEL_CUST_SIGN,
		SEC_DEL_THIRD_PARTY_SIGN, 
		EYE_TDO_SIGN,
		PCD_TDO_SIGN,
		NOWTV_TDO_SIGN,
		SEC_DEL_TDO_SIGN,
		IDD_0060_TDO_SIGN,
		EYE_PRODUCT_SPEC_SIGN,
		RECONTRACT_FROM_SIGN,
		RECONTRACT_TO_SIGN,
		PIPB_NSD_SIGN,
		IGUARD_CARECASH  //MB2016081 TC
		;
	}
