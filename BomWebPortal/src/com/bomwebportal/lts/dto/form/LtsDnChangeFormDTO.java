...
public class LtsDnChangeFormDTO implements Serializable {


	private static final long serialVersionUID = -3966226596195187265L;
	...
	public static String getSearchNoCriteriaRadioButton() {
		return SEARCH_NO_CRITERIA_RADIO_BUTTON;
	}

	public static String getReservedDnRadioButton() {
		return RESERVED_DN_RADIO_BUTTON;
	}
