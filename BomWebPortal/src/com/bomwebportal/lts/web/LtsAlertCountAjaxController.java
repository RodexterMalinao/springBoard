...
public class LtsAlertCountAjaxController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		logger.info("LtssAlertCountAjaxController handle Request: ");
		...
		try {
			alertCounter = this.ltsAlertMessageService.getAlertCount(LtsConstant.ALERT_MSG_SRV_TYPE_TEL, username);
		} catch (Exception e) {
		...
		logger.info("LtsDsAjaxController handle Request: (end)");
