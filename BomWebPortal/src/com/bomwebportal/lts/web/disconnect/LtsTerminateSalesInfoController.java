...
public class LtsTerminateSalesInfoController extends SimpleFormController {
	protected final Log log = LogFactory.getLog(getClass());
	private LtsSalesInfoService ltsSalesInfoService;
	private final String nextView = "ltsterminatebillinginfo.html";
	private final String viewName = "lts/disconnect/ltsterminatesalesinfo";
	private final String commandName = "ltsTerminateSalesInfoCmd";
	
	public LtsTerminateSalesInfoController() {
		setFormView("lts/disconnect/ltsterminatesalesinfo");
		setCommandName(commandName);
		setCommandClass(LtsSalesInfoFormDTO.class);
	}
...
//			}
		...
		ltsSalesInfoFormDTO.setCallCenter(bomSalesUserDTO.getChannelId() == Integer.parseInt(LtsConstant.CHANNEL_ID_CS));
		ltsSalesInfoFormDTO.setPremier(bomSalesUserDTO.getChannelId() == Integer.parseInt(LtsConstant.CHANNEL_ID_PREMIER));
		if(StringUtils.isBlank(ltsSalesInfoFormDTO.getImsApplicationMethod())){
			if(ltsSalesInfoFormDTO.isCallCenter()){
				ltsSalesInfoFormDTO.setImsApplicationMethod(LtsConstant.IMS_APPLICATION_METHOD_CALL_CENTER);
			}else if(ltsSalesInfoFormDTO.isPremier()){
	...
	public ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws ServletException {
		...
		orderCaptureDTO.setLtsSalesInfoForm(ltsSalesInfoFormDTO);
//		orderCaptureDTO.setLtsTerminateBillingInfoForm(null);
