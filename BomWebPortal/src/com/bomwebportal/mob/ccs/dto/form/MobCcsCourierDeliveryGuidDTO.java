...
public class MobCcsCourierDeliveryGuidDTO extends ReportDTO{
    ...
    public static final String JASPER_TEMPLATE_CG = "CourierGuideline";

	public MobCcsCourierDeliveryGuidDTO(){
		this.mnpInd = false;
		...
		//this.octFlag = ""; //Athena 2013092
		this.studentPlanFlag = false;
		this.setHkbnInd(false);
    ...
    private boolean throughPickUp;
 	...
 	private boolean receiveCopy; // add by Joyce 20121206, item 8
 	private String bankNameChi; // add by Joyce 20130313
