...
public class StockManualDetailValidator implements Validator{
	...
	public void validate(Object obj, Errors errors) {
		...
		StockManualDetailUI dto = (StockManualDetailUI)obj;
		
		if ("QUIT".equalsIgnoreCase(dto.getActionType())) {
			return;
		}
		...
		if (orderInfo != null && orderInfo.size() > 0) {
			...
			* */
			...
			String orderId = null;
			if (orderInfo.get(0)[0] != null) {
				orderId = orderInfo.get(0)[0].toString();
			}
			
			String orderType = null;
			if (orderInfo.get(0)[1] != null) {
				orderType = orderInfo.get(0)[1].toString();
			}
			
			String orderStatus = null;
			if (orderInfo.get(0)[2] != null) {
				orderStatus = orderInfo.get(0)[2].toString();
			}
			
			String checkPoint = null;
			if (orderInfo.get(0)[3] != null) {
				checkPoint = orderInfo.get(0)[3].toString();
			}
			
			String reasonCode = null;
			if (orderInfo.get(0)[4] != null) {
				reasonCode = orderInfo.get(0)[4].toString();
			}
			
			Date deliveryDate = null;
			if (orderInfo.get(0)[5] != null) {
				deliveryDate = (Date)(orderInfo.get(0)[5]);
			}
			
			String b4_1500 = null;
			if (orderInfo.get(0)[6] != null) {
				b4_1500 = orderInfo.get(0)[6].toString();
			}
