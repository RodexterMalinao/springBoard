...
@Component("template.MOB.RT013")
public class RT013 implements EmailTemplateHandler {
		...
		try {
			...
			try{
				...
				if (req.getBrand() == null) {
					...
					shopBrand = mobMessageSource.getMessage("mob.RT013.shopBrand.csl", null, locale);
					
				}else if (req.getBrand() != null) {
												
					shopBrand = mobMessageSource.getMessage("mob.RT013.shopBrand."+req.getBrand(), null, locale);
