...
public class SbsDeliveryInfoDTO {
	...
	public void setDeliveryTimeSlotDesc(String deliveryTimeSlotDesc) {
		this.deliveryTimeSlotDesc = deliveryTimeSlotDesc;
	}

	
	public String composeSingleLineAddress() {
		...
		if (StringUtils.isNotEmpty(strName)) {
			...
			sb.append(" ");
			sb.append(this.strCatDesc);
			sb.append(" ");
		}

		if (StringUtils.isNotEmpty(sectDesc)) {
			sb.append(this.sectDesc);
			sb.append(" ");
		}
		if (StringUtils.isNotEmpty(distDesc)) {
			sb.append(this.distDesc);
			sb.append(" ");
		}
