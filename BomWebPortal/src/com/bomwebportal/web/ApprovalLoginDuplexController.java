...
public class ApprovalLoginDuplexController extends SimpleFormController{
protected final Log logger = LogFactory.getLog(getClass());
	...
	public Object formBackingObject(HttpServletRequest request) throws ServletException {
		...
		if(orderCapture.getApprovalDuplexLoginForm() !=null){
			return orderCapture.getApprovalDuplexLoginForm();
		}
	...
	public ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws ServletException {
		...
		if(StringUtils.equals(loginedUser.getCategory(), "SALES MANAGER")
		    ...
		    orderCapture.setApprovalDuplexLoginForm(approvalUser);
			return new ModelAndView(new RedirectView("closepopup.jsp"));
		}   
	    return new ModelAndView(new RedirectView("approvalloginduplex.html"));
	}
}
