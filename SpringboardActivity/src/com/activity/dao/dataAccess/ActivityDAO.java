...
public class ActivityDAO extends DaoBaseImpl {

	private static final long serialVersionUID = -2898411804019305273L;
	...
	public ActivityDAO() {
		primaryKeyFields = new String[] { "actvId" };
	}
	...
	public String getProfileId() {
		return this.profileId != null ? this.profileId.toString() : null;
	}
	...
	public void setKeyA(String pKeyA) {
		this.keyA = pKeyA;
	}

	public void setKeyB(String pKeyB) {
		this.keyB = pKeyB;
	}

	public void setKeyC(String pKeyC) {
		this.keyC = pKeyC;
	}

	public void setKeyD(String pKeyD) {
		this.keyD = pKeyD;
	}

	public void setKeyE(String pKeyE) {
		this.keyE = pKeyE;
	}

	public void setKeyF(String pKeyF) {
		this.keyF = pKeyF;
	}

	public void setKeyG(String pKeyG) {
		this.keyG = pKeyG;
	}

	public void setKeyH(String pKeyH) {
		this.keyH = pKeyH;
	}

	public void setKeyI(String pKeyI) {
		this.keyI = pKeyI;
	}

	public void setKeyJ(String pKeyJ) {
		this.keyJ = pKeyJ;
	}
	...
	public void setProfileId(String pProfileId) {
		this.profileId = new OraNumber(pProfileId);
	}
