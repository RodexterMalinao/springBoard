...
import com.bomwebportal.lts.dao.LtsAcqDnPoolDAO;
...
public class LtsAcqDnPoolServiceImpl implements LtsAcqDnPoolService {
	...
	public void updDnStatusToReserve(List<String> dnList, String oStatus, String sessionId) {
		updDnStatusToReserve(dnList, oStatus, sessionId, "TLTSACQ");
	}
	
	@Transactional
	public void updDnStatusToReserve(List<String> dnList, String oStatus, String sessionId, String staffId) {
		try {
			ltsAcqDnPoolDAO.updDnStatusToReserve(dnList, oStatus, sessionId, staffId);
		}
		catch (DAOException de) {
			logger.error(ExceptionUtils.getFullStackTrace(de));
			throw new RuntimeException(de.getCustomMessage());
	...
	public void updDnStatusToConfirm(String srvNum, String sessionId) {
		updDnStatusToConfirm(srvNum, sessionId, "TLTSACQ");
	}
	
	@Transactional
	public void updDnStatusToConfirm(String srvNum, String sessionId, String staffId) {
		try {
			ltsAcqDnPoolDAO.updDnStatusToConfirm(srvNum, sessionId, staffId);
		}
		catch (DAOException de) {
			logger.error(ExceptionUtils.getFullStackTrace(de));
			throw new RuntimeException(de.getCustomMessage());
	...
	public void updDnStatusToNormal(String oStatus, String sessionId) {
		updDnStatusToNormal(oStatus, sessionId, "TLTSACQ");
	}
	
	@Transactional
	public void updDnStatusToNormal(String oStatus, String sessionId, String staffId) {
		try {
			ltsAcqDnPoolDAO.updDnStatusToNormal(oStatus, sessionId, staffId);
		}
		catch (DAOException de) {
			logger.error(ExceptionUtils.getFullStackTrace(de));
			throw new RuntimeException(de.getCustomMessage());
	...
	public void updDnStatusToNormalBySrvNum(List<String> dnList, String oStatus, String sessionId) {
		updDnStatusToNormalBySrvNum(dnList, oStatus, sessionId, "TLTSACQ");
	}
	
	@Transactional
	public void updDnStatusToNormalBySrvNum(List<String> dnList, String oStatus, String sessionId, String staffId) {
		try {
			ltsAcqDnPoolDAO.updDnStatusToNormalBySrvNum(dnList, oStatus, sessionId, staffId);
		}
		catch (DAOException de) {
			logger.error(ExceptionUtils.getFullStackTrace(de));
			throw new RuntimeException(de.getCustomMessage());
	...
	public void releaseDnStatusToLockedByReservedDn(List<String> dnList, String sessionId) {
		releaseDnStatusToLockedByReservedDn(dnList, sessionId, "TLTSACQ");
	}
	
	@Transactional
	public void releaseDnStatusToLockedByReservedDn(List<String> dnList, String sessionId, String staffId) {
		try {
			ltsAcqDnPoolDAO.releaseDnStatusToLockedByReservedDn(dnList, sessionId, staffId);
		}
		catch (DAOException de) {
			logger.error(ExceptionUtils.getFullStackTrace(de));
			throw new RuntimeException(de.getCustomMessage());
