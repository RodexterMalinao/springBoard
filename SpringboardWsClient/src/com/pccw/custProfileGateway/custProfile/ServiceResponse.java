...
@XmlSeeAlso({
    CustTagEnqResponse.class,
    CallPlanInfoEnqResponse.class,
    ValidateCustInfoEnqResponse.class,
    ContactInfoUpdResponse.class,
    InvPreassgnJunctionMsgUpdResponse.class,
    CustNumEnqResponse.class,
    ContactInfoEnqResponse.class,
