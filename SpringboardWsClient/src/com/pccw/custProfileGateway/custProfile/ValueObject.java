...
@XmlSeeAlso({
    BillRegWrapperDTO.class,
    AcctEnqWrapperDTO.class,
    ContactInfoDTO.class,
    TermPlanEnqWrapperDTO.class,
    DataPrivacyLtsDTO.class,
    CallPlanEnqWrapperDTO.class,
    CallPlanDtlEnqWrapperDTO.class,
    CustTagEnqBaseDTO.class,
    RecontractRmksDTO.class,
    AcctEnqDTO.class,
    OptInInfoDTO.class,
    CallPlanDtlEnqDTO.class,
    ConsentHistoryDTO.class,
    ServiceResponse.class,
    CallPlanInfoDTO.class,
    CustTagDTO.class,
    OptOutInfoDTO.class,
    AddressDTO.class,
    CustomerDTO.class,
    DataPrivacyNotiInfoLtsDTO.class,
    SalesInfoDTO.class,
    CustomerRmkDTO.class,
    BillRegDTO.class,
    WIPRmksDTO.class,
    OptOutInfoGroupDTO.class,
    TermPlanEnqDTO.class,
    CallPlanEnqDTO.class,
    MembershipInfoDTO.class,
    SpecialHandlingRmksDTO.class,
    SpecialSRHandlingRmksDTO.class
})
