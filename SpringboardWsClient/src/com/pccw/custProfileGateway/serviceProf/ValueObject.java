...
@XmlSeeAlso({
    DNAssignmentResultDTO.class,
    OrdSalesInfoDTO.class,
    ArpuInfoDTO.class,
    ServiceResponse.class,
    LegacyOrderDTO.class,
    AddressDTO.class,
    LegacyOrderActivityDTO.class,
    RemarksDTO.class,
    UamsAppointmentDTO.class,
    GenericFixFieldDTO.class,
    OrdDetailDTO.class,
    DNAssignmentOptionDTO.class,
    OrdDetailRemarkDTO.class,
    DnDTO.class,
    ValueObjectWithAction.class
})
